              ...
              <div className="container">
                <div className="page-banner-entry text-center">
                  ...
                  <h1 className="edited-details">
                    130 Tri-County Parkway, Suite 215 Cincinnati, OH 45246
                  </h1>
                  <h1 className="edited-details">Telephone : 513-825-9080</h1>
                  <h1 className="edited-details">
                    Email : efeurhobos@netzero.com
                  </h1>
                    ...
                    >
                      <div className="info-inner">
                        ...
                        <div className="icon-box">
                          ...
                          <p>130 Tri-County Parkway, Cincinnati, OH 45246</p>
                        </div>
                        <div className="icon-box">
                          <h6 className="title">
                          ...
                          <Link to="#" className="text-white">
                            efeurhobos@netzero.com
                          </Link>
                          <p>Tel: 513-825-9080</p>
                        </div>
                        <div className="icon-box">
                          <h6 className="title">
