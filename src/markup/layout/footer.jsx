                ...
                <div className="col-xl-3 col-lg-3 col-md-6">
                  <div className="widget widget_info">
                    <div className="footer-logo">
                      <h1 className="brandName">Millenium Nursing Agency</h1>
                    </div>
                    <div className="ft-contact">
                      <p>
                        Integrity Home Care & Nursing Agency is a Family owned
                        agency dedicated to providing superior in-home care and
                        skilled nursing services. Feel better in the comfort of
                        your home. We specialize in providing assistance with
                        all activities of daily living and skilled nursing.
                      </p>
                      <div className="contact-bx">
                        ...
                        <div className="contact-number">
                          ...
                          <h4 className="number">Tel: 513-825-9080</h4>
                        </div>
                      </div>
                    </div>
                  </div>
